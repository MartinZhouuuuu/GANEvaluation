...
if __name__ == '__main__':
    ...
    for j in range(200):
        ...
        utils.save_image(img, f'sample_mixing_{j}.png', nrow=args.n_col, normalize=True, range=(-1, 1))
    '''
    for j in range(200):
        
        img = style_mixing(generator, step, mean_style, args.n_col, args.n_row, device)
        utils.save_image(
            img, f'sample_mixing_{j}.png', nrow=args.n_col, normalize=True, range=(-1, 1)
        )
    '''