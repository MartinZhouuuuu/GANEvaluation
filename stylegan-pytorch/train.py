...
def accumulate(model1, model2, decay=0.999):
    ...
    for k in par1.keys():
        #mul_() replaces the original value, mul() keeps the original one
        #both mul() and add() applies to each element
...
def train(args, dataset, generator, discriminator):
    ...
    #different learning rate at each resolution 
